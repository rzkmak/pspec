...
10. Return the saved file path and a brief summary of assumptions or notable decisions.
11. Ask for approval once, after the draft is written. Then offer `/pspec.plan` as the next step.
