...
> **AI INSTRUCTION:** Read `.mspec/specs/003-implement-command.md`. Break down the requirements into granular, sequential implementation tasks below. Use checkboxes (`- [ ]`). Group by phases.
...
- [x] Resolve path for `.mspec/tasks/<spec-name>.tasks.md`.
