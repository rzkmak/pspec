...
> **AI INSTRUCTION:** Read `.mspec/specs/002-plan-command.md`. Break down the requirements into granular, sequential implementation tasks below. Use checkboxes (`- [ ]`). Group by phases.
...
- [x] Resolve paths for the `.mspec/specs/<spec-name>.md` and `.mspec/tasks/<spec-name>.tasks.md`.
...
- [x] Write boilerplate to `.mspec/tasks/<spec-name>.tasks.md`.
